CREATE PROCEDURE [dbo].[spWEB_CarteraDiferidaPdteEjecutar_AGRUP]
	@Usuario varchar(50), 		
	@pAño int,
	@pMes int
	AS
  ...
  --  IF UPPER(@Usuario_Sin_Fecha)='ELUQUE' -- Para depuración
	...
	IF (@Usuario_Puesto='DG')
		BEGIN	
			...
			SELECT  'Contratos Marco', dbo.Sumarigrama.CodDirGeneral, dbo.Sumarigrama.NombreDirGeneral, dbo.Sumarigrama.CodSubDirGeneral,dbo.Sumarigrama.NombreSubDirGeneral, dbo.Sumarigrama.CodDDirNegocio, dbo.Sumarigrama.NombreDirNegocio, dbo.Sumarigrama.CodSubDirNegocioArea,dbo.Sumarigrama.NombreSubDirNegocioArea, dbo.Sumarigrama.CodDelegacion, dbo.Sumarigrama.NombreDelegacion, dbo.Sumarigrama.CodCentro,dbo.Sumarigrama.NombreCentro, Cart_DiferidaContratosSQL.Contrato, Cart_DiferidaOfertasContratos_2016SQL.NomAgrupado, dbo.CentrosGerentesSQL.NombreGerente AS Gerencia,Cart_DiferidaContratosSQL.FInicio, Cart_DiferidaContratosSQL.FFinal, Cart_DiferidaContratosSQL.FFinalEfectiva, dbo.Cart_DiferidaOfertasContratos_2016SQL.CodOferta, Cart_DiferidaContratosSQL.Tipo, Cart_DiferidaContratosSQL.Mercado, dbo.Cart_DiferidaOfertasContratos_2016SQL.CartInicio, dbo.Cart_DiferidaOfertasContratos_2016SQL.NTrimestres, dbo.Cart_DiferidaOfertasContratos_2016SQL.MontoTrimestre, dbo.Cart_DiferidaOfertasContratos_2016SQL.MontoAnual, dbo.Cart_DiferidaOfertasContratos_2016SQL.NTrimestres * dbo.Cart_DiferidaOfertasContratos_2016SQL.MontoTrimestre AS PrevistoAño, dbo.Cart_DiferidaOfertasContratos_2016SQL.NTrimestres * dbo.Cart_DiferidaOfertasContratos_2016SQL.MontoTrimestre - dbo.Cart_DiferidaOfertasContratos_2016SQL.CartInicio AS Nuevo, ISNULL(vwCarteraDiferidaSQLContratado.AñoSQL, 0) + ISNULL(vwContratacion_SQL_AS400_2019.Importe, 0) AS Contrat, ISNULL(vwCarteraDiferidaSQLContratado.TrimSQL, 0) AS TrimSQL, ISNULL(vwContratacion_SQL_AS400_2019.Importe, 0) - ISNULL(vwCarteraDiferidaSQLContratado.TrimSQL, 0) AS Regu, 
			...
			FROM      (SELECT ID, Contrato, Cliente, CodigoContratoClient, Gerencia, Prorrogable, Tipo, Mercado, FInicio, FFinal, FFinalEfectiva, Zona
					   ...
					   (SELECT CODOFER, Importe FROM dbo.fnContratacionAcumulada_SQL_AS400_2019(@pMes)) AS vwContratacion_SQL_AS400_2019 ON 
						dbo.Cart_DiferidaOfertasContratos_2016SQL.CodOferta = vwContratacion_SQL_AS400_2019.CODOFER LEFT OUTER JOIN						
			...
			--			FROM dbo.fnContratacionAcumulada_SQL_AS400_2019(@pMes)) AS vwContratacion_SQL_AS400_2019 ON 
			--			dbo.Cart_DiferidaOfertasContratos_2016SQL.CodOferta = vwContratacion_SQL_AS400_2019.CODOFER LEFT OUTER JOIN						
			--			(SELECT * FROM vwCarteraDiferidaSQLContratado WHERE Año=@pAño) vwCarteraDiferidaSQLContratado ON dbo.Cart_DiferidaOfertasContratos_2016SQL.CodOferta = vwCarteraDiferidaSQLContratado.CodOferta
			...
			FROM  dbo.ObrasActualesSQL INNER JOIN
				  vwEnlaces_ALL_1 as vwEnlaces_Detallado ON dbo.ObrasActualesSQL.CTR = vwEnlaces_Detallado.CTRO AND 
			...
			INSERT INTO #RestoOfertas(Gerencia,Cliente,CodCentro,CodOferta)
			SELECT dbo.CentrosGerentesSQL.NombreGerente, dbo.ClientesSQL.NomAgrupado, dbo.vwContratacionOfertas_SQL_AS400_2019.CodCentro, dbo.vwContratacionOfertas_SQL_AS400_2019.CODOFER
			FROM   dbo.vwContratacionOfertas_SQL_AS400_2019 INNER JOIN
                   dbo.CentrosGerentesSQL ON dbo.vwContratacionOfertas_SQL_AS400_2019.CodCentro = dbo.CentrosGerentesSQL.CodCentro AND dbo.CentrosGerentesSQL.Año=2019 INNER JOIN
                   dbo.ClientesSQL ON dbo.vwContratacionOfertas_SQL_AS400_2019.CODCLIENTE = dbo.ClientesSQL.CodCliente LEFT OUTER JOIN
				   #RestoOfertas ON dbo.vwContratacionOfertas_SQL_AS400_2019.CODOFER = #RestoOfertas.CodOferta
			...
			SELECT  'Resto', dbo.Sumarigrama.CodDirGeneral, dbo.Sumarigrama.NombreDirGeneral, dbo.Sumarigrama.CodSubDirGeneral,dbo.Sumarigrama.NombreSubDirGeneral, dbo.Sumarigrama.CodDDirNegocio, dbo.Sumarigrama.NombreDirNegocio, dbo.Sumarigrama.CodSubDirNegocioArea,dbo.Sumarigrama.NombreSubDirNegocioArea, dbo.Sumarigrama.CodDelegacion, dbo.Sumarigrama.NombreDelegacion, dbo.Sumarigrama.CodCentro,dbo.Sumarigrama.NombreCentro,
					...
					ISNULL(vwCarteraDiferidaSQLContratado.AñoSQL, 0) + ISNULL(vwContratacion_SQL_AS400_2019.Importe, 0) AS Contrat,ISNULL(vwCarteraDiferidaSQLContratado.TrimSQL, 0) AS TrimSQL, ISNULL(vwContratacion_SQL_AS400_2019.Importe, 0) - ISNULL(vwCarteraDiferidaSQLContratado.TrimSQL, 0) AS Regu, 
			...
			FROM    #RestoOfertas INNER JOIN
					...
					(SELECT CodCentro, CODOFER, DESOFER, CODCLIENTE, NOMCLIENTE, Importe FROM dbo.fnContratacionAcumulada_SQL_AS400_2019(@pMes)) AS vwContratacion_SQL_AS400_2019
					ON #RestoOfertas.CodCentro = vwContratacion_SQL_AS400_2019.CodCentro AND #RestoOfertas.CodOferta = vwContratacion_SQL_AS400_2019.CODOFER LEFT OUTER JOIN						
	...
	ELSE IF (@Usuario_Puesto='SDG')
		BEGIN
			...
			--			dbo.Cart_DiferidaOfertasContratos_2016SQL.CodOferta = vwContratacion_SQL_AS400_2019.CODOFER LEFT OUTER JOIN						
			--			(SELECT * FROM vwCarteraDiferidaSQLContratado WHERE Año=@pAño) vwCarteraDiferidaSQLContratado ON dbo.Cart_DiferidaOfertasContratos_2016SQL.CodOferta = vwCarteraDiferidaSQLContratado.CodOferta
			--WHERE CodSubDirGeneral = @Usuario_CodEntidad AND Cart_DiferidaContratosSQL.Gerencia = 'Contratos Nacionales' and Vigente=1
			...
			FROM    #RestoOfertas INNER JOIN
					dbo.Sumarigrama ON #RestoOfertas.CodCentro = dbo.Sumarigrama.CodCentro LEFT OUTER JOIN
					(SELECT CodCentro, CODOFER, DESOFER, CODCLIENTE, NOMCLIENTE, Importe FROM dbo.fnContratacionAcumulada_SQL_AS400_2019(@pMes)) AS vwContratacion_SQL_AS400_2019
					ON #RestoOfertas.CodOferta = vwContratacion_SQL_AS400_2019.CODOFER LEFT OUTER JOIN						
					(SELECT * FROM vwCarteraDiferidaSQLContratado WHERE Año=@pAño) vwCarteraDiferidaSQLContratado
					ON #RestoOfertas.CodOferta = vwCarteraDiferidaSQLContratado.CodOferta		
	...
	ELSE IF (@Usuario_Puesto='DN')
		BEGIN
			...
			--			dbo.Cart_DiferidaOfertasContratos_2016SQL.CodOferta = vwContratacion_SQL_AS400_2019.CODOFER LEFT OUTER JOIN						
			--			(SELECT * FROM vwCarteraDiferidaSQLContratado WHERE Año=@pAño) vwCarteraDiferidaSQLContratado ON dbo.Cart_DiferidaOfertasContratos_2016SQL.CodOferta = vwCarteraDiferidaSQLContratado.CodOferta
			--WHERE CodDDirNegocio = @Usuario_CodEntidad AND Cart_DiferidaContratosSQL.Gerencia = 'Contratos Nacionales' and Vigente=1		
	...
	ELSE IF (@Usuario_Puesto='AREA')
		BEGIN
			...
			--			dbo.Cart_DiferidaOfertasContratos_2016SQL.CodOferta = vwContratacion_SQL_AS400_2019.CODOFER LEFT OUTER JOIN						
			--			(SELECT * FROM vwCarteraDiferidaSQLContratado WHERE Año=@pAño) vwCarteraDiferidaSQLContratado ON dbo.Cart_DiferidaOfertasContratos_2016SQL.CodOferta = vwCarteraDiferidaSQLContratado.CodOferta
			--WHERE CodSubDirNegocioArea = @Usuario_CodEntidad AND Cart_DiferidaContratosSQL.Gerencia = 'Contratos Nacionales' and Vigente=1		
	...
	ELSE IF (@Usuario_Puesto='DEL')
		BEGIN
			...
			--			dbo.Cart_DiferidaOfertasContratos_2016SQL.CodOferta = vwContratacion_SQL_AS400_2019.CODOFER LEFT OUTER JOIN						
			--			(SELECT * FROM vwCarteraDiferidaSQLContratado WHERE Año=@pAño) vwCarteraDiferidaSQLContratado ON dbo.Cart_DiferidaOfertasContratos_2016SQL.CodOferta = vwCarteraDiferidaSQLContratado.CodOferta
			--WHERE CodDelegacion = @Usuario_CodEntidad AND Cart_DiferidaContratosSQL.Gerencia = 'Contratos Nacionales' and Vigente=1		
	...
	ELSE IF (@Usuario_Puesto='CT')
		BEGIN			
			...
			--			dbo.Cart_DiferidaOfertasContratos_2016SQL.CodOferta = vwContratacion_SQL_AS400_2019.CODOFER LEFT OUTER JOIN						
			--			(SELECT * FROM vwCarteraDiferidaSQLContratado WHERE Año=@pAño) vwCarteraDiferidaSQLContratado ON dbo.Cart_DiferidaOfertasContratos_2016SQL.CodOferta = vwCarteraDiferidaSQLContratado.CodOferta
			--WHERE Sumarigrama.CodCentro = @Usuario_CodEntidad AND Cart_DiferidaContratosSQL.Gerencia = 'Contratos Nacionales' and Vigente=1		
	...
	--SET @SQL_AS400_from = 'SELECT * FROM OPENQUERY(SIC, 
	--						''SELECT DISTINCT OFCA.CDCEN, OFCA.CDOFT,  OFCA.DCOF,  OFCA.FECHAD, OFCA.TVEN,  OFCA.WS10
	--						 FROM  S44DD901.ICOMERF.IC09AP As OFCA INNER JOIN S44DD901.FICOSCO.CO005BP AS Enlaces ON
	--								OFCA.CDCEN = Enlaces.CTRO AND OFCA.CDOFT = Enlaces.CDOFT
	--						 WHERE 
	--							((substr( digits(dec(19000000+OFCA.FECHAA,8,0)), 1, 4 ) < ' + str(@pAño) + ') OR 
	--							 (substr( digits(dec(19000000+OFCA.FECHAA,8,0)), 1, 4 ) = ' + str(@pAño) + ' AND substr( digits(dec(19000000+OFCA.FECHAA,8,0)), 5, 2 ) <= ' + str(@pMes) + ')
	--							) AND
	--							 (OFCA.ADELE = ''''S'''' AND Enlaces.CDOFT IS NOT NULL) AND substr( digits(dec(19000000+OFCA.FECHAA,8,0)), 1, 4 )>=2005
	--						'')'		
	...
	INSERT into #vRegularizaciones(CodCentro,CodOferta,ImporteRegularizacion) 
	SELECT cdcen,cdoft,sum(Impre)
			FROM vwRegularizaciones_2019_Sup 
	...
	FROM #WEB_CarteraUsuarioCentro_TMP
	      LEFT JOIN (SELECT * FROM vwTIPOUNO_Produccion_Detallado WHERE (Año=@pAño AND Mes=@pMes) OR isnull(Año,0)=0 ) vwTIPOUNO_Produccion_Detallado on [#WEB_CarteraUsuarioCentro_TMP].CodOferta=vwTIPOUNO_Produccion_Detallado.CodOferta AND 
...
-------------------------------------
	...
	*/
	...
	FROM ( SELECT * FROM vwEnlaces_CDOFT_1) E INNER JOIN
