...
CREATE PROCEDURE [dbo].[spContratacion_Mensual_Acumulada_AñoAnterior_ACTIVIDAD_DN_RESTO] 		
	@pAño int,
	@pMes int
	AS
BEGIN
	...
	SELECT CodSubDirGeneral,CodDDirNegocio,NombreDirNegocio,CodAct1,CodAct2,Sum(ImporteContratadoAcumulado) as ImporteContratadoAcumulado, sum(ImporteContratadoAcumuladoAñoAnterior) as ImporteContratadoAcumuladoAñoAnterior 
	FROM (
	...
	GROUP BY CodSubDirGeneral,CodDDirNegocio,NombreDirNegocio,CodAct1,CodAct2
	--order by CodSubDirGeneral,NombreDirNegocio
