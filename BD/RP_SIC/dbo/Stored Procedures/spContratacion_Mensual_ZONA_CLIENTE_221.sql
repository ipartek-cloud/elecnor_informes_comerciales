...
CREATE PROCEDURE [dbo].[spContratacion_Mensual_ZONA_CLIENTE_221] 		
	@pAño int,
	@pMes int
	AS
BEGIN
	...
	SELECT 1 as Orden,NombreDirNegocio as Nombre,'' as AgrupacionCentro,NomAgrupado +' ('+ dbo.fnPaises(Mercado,ClientesSQL.Pais) +')' as Cliente,DescripcionOferta, Sum(ImporteContratadoAcumulado) as ImporteContratadoMensual
	FROM @vContratacion 
	...
	GROUP BY dbo.fnPaises(Mercado,ClientesSQL.Pais),NombreDirNegocio,NomAgrupado,DescripcionOferta
	--order by NombreDirNegocio, ImporteContratadoAcumulado desc
