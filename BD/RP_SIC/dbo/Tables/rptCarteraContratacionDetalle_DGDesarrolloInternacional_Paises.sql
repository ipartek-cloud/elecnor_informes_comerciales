CREATE TABLE [dbo].[rptCarteraContratacionDetalle_DGDesarrolloInternacional_Paises] (
    ...
    [LoginUsuario]            NVARCHAR (100)  CONSTRAINT [DF_rptCartContrDet_Login] DEFAULT ('ACCESS') NULL,
    [FechaCreacion]           DATETIME        CONSTRAINT [DF_rptCartContrDet_Fecha] DEFAULT (getdate()) NULL
);
