CREATE TABLE [dbo].[rptContratacion_Internacional] (
    ...
    [LoginUsuario]                          NVARCHAR (100)  CONSTRAINT [DF_rptContrInt_Login] DEFAULT ('ACCESS') NULL,
    [FechaCreacion]                         DATETIME        CONSTRAINT [DF_rptContrInt_Fecha] DEFAULT (getdate()) NULL,
