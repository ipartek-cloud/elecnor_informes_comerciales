...
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwRPI_Asuntos';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'         Column = 9915
         Alias = 2070
         Table = 1170
         Output = 720
         Append = 1400
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwRPI_Asuntos';
