CREATE VIEW dbo.vwOfertas_Encuestas
AS
SELECT        CDOFT, DCOF, CDAC1, CDAC2, CDCLI, CDCEN
FROM            OPENQUERY(SIC, 
                         'SELECT DISTINCT  OFCA.CDOFT, OFCA.DCOF,OFCA.CDAC1, OFCA.CDAC2,OFCA.CDCLI,OFCA.CDCEN
