...
CREATE VIEW [dbo].[vwRPI_Asuntos_Singulares_OLD]
AS
SELECT        TOP (100) PERCENT dbo.RPI_Asuntos.idAsunto, dbo.RPI_Asuntos.FechaAsunto, dbo.RPI_Asuntos.MontoAsunto, dbo.RPI_Asuntos.FechaPresentado, 
                         ...
                         dbo.RPI_Asuntos.GrandesRedes_LineasUE, dbo.RPI_Asuntos.Energia_Audeca, dbo.RPI_Asuntos.Energia_Area4_FFCC, 
                         CASE WHEN dbo.RPI_Asuntos.FechaEnVigor = '' THEN 2999 ELSE year(dbo.RPI_Asuntos.FechaEnVigor) END AS FechaEnVigorSinAño, 
                         CASE WHEN dbo.RPI_Asuntos.FechaDenegado = '' THEN 2999 ELSE year(dbo.RPI_Asuntos.FechaDenegado) END AS FechaDenegadoSinAño, 
                         dbo.RPI_Asuntos.Anexo1, dbo.RPI_Asuntos.Anexo2, dbo.RPI_Asuntos.Anexo3
