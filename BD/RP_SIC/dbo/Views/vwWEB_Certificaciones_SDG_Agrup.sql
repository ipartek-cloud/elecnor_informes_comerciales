...
CREATE VIEW [dbo].[vwWEB_Certificaciones_SDG_Agrup]
AS
SELECT        Usuario,  CodSubDirGeneral, NombreSubDirGeneral, SUM(NumReferencias_ALL) AS NumReferencias_ALL, SUM(NumCBE_ALL) AS NumCBE_ALL, SUM(NumOfertas_2016) 
...
GROUP BY Usuario, CodSubDirGeneral, NombreSubDirGeneral
