CREATE VIEW [dbo].[vwWEB_Certificaciones_DEL_Agrup]
AS
SELECT        Usuario, CodDelegacion, NombreDelegacion, SUM(NumReferencias_ALL) AS NumReferencias_ALL, SUM(NumCBE_ALL) AS NumCBE_ALL, SUM(NumOfertas_2016) 
...
GROUP BY Usuario,CodDelegacion, NombreDelegacion