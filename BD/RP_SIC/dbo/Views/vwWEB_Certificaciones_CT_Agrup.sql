CREATE VIEW [dbo].[vwWEB_Certificaciones_CT_Agrup]
AS
SELECT        Usuario, CodCentro, NombreCentro, SUM(NumReferencias_ALL) AS NumReferencias_ALL, SUM(NumCBE_ALL) AS NumCBE_ALL, SUM(NumOfertas_2016) 
...
GROUP BY Usuario,CodCentro, NombreCentro