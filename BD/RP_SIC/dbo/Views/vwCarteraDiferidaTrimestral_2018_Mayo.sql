CREATE VIEW dbo.vwCarteraDiferidaTrimestral_2018_Mayo
AS
...
FROM            (SELECT        ID, Contrato, Cliente, CodigoContratoClient, Gerencia, Prorrogable, Tipo, Mercado, FInicio, FFinal, FFinalEfectiva, Zona
                          FROM            dbo.fnCart_DiferidaContratosSQL('T') AS fnCart_DiferidaContratosSQL_1) AS Cart_DiferidaContratosSQL INNER JOIN
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'  Width = 1500
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwCarteraDiferidaTrimestral_2018_Mayo';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwCarteraDiferidaTrimestral_2018_Mayo';
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[29] 4[14] 2[41] 3) )"
      End
