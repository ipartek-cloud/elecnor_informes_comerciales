CREATE VIEW dbo.Regularizaciones
AS
SELECT        CDCEN, CDOFT, NUMRE, FECHAR, CAUS, IMPRE, CTOT, [00008], WS10, AA, MM, DD, AA AS AñoR, MM AS MesR
FROM            OPENQUERY(SIC, 
                         '
SELECT CDCEN, CDOFT, NUMRE, FECHAR, CAUS, IMPRE, CTOT, USER, WS10,
