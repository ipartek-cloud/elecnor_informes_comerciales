...
CREATE VIEW [dbo].[vwWEB_CarteraDiferida_DN_DEL_GERENCIA_TipoContrato_Cliente_Contrato_Anual_Trimestral]
AS
SELECT        Usuario, Año, Mes, CodDDirNegocio, NombreDirNegocio, CodDelegacion, NombreDelegacion, GERENCIA,AGRUP,Cliente,Contrato,Finicio,FFinal,FFinalEfectiva  AS Prorroga, 
...
GROUP BY Usuario, Año, Mes, CodDDirNegocio, NombreDirNegocio, CodDelegacion, NombreDelegacion, GERENCIA,AGRUP,Cliente,Contrato,Finicio,FFinal,FFinalEfectiva
