CREATE VIEW [dbo].[vwWEB_CarteraDiferida_DN_GERENCIA_Agrup_Anual_Trimestral]
AS
SELECT        Usuario, Año, Mes,CodDDirNegocio, NombreDirNegocio, Gerencia, SUM(CASE TIPO WHEN 'T' THEN NTrimestre * MontoTrimestre ELSE MontoAnual END) AS Total, SUM(Contrat) AS Contrat, 
...
GROUP BY Usuario, Año, Mes,CodDDirNegocio,NombreDirNegocio, Gerencia