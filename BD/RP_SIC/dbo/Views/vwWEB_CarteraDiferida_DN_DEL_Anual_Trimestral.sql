CREATE VIEW dbo.[vwWEB_CarteraDiferida_DN_DEL_Anual_Trimestral]
AS
SELECT        Usuario, Año, Mes, CodDDirNegocio, NombreDirNegocio, CodDelegacion, NombreDelegacion, 
...
GROUP BY Usuario, Año, Mes, CodDDirNegocio, NombreDirNegocio, CodDelegacion, NombreDelegacion
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwWEB_CarteraDiferida_DN_DEL_Anual_Trimestral';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwWEB_CarteraDiferida_DN_DEL_Anual_Trimestral';
