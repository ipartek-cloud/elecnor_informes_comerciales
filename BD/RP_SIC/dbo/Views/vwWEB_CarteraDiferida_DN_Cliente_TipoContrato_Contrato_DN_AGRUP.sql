CREATE VIEW [dbo].[vwWEB_CarteraDiferida_DN_Cliente_TipoContrato_Contrato_DN_AGRUP]
AS
SELECT        Usuario, Año, Mes,  Cliente, AGRUP, Contrato, CodDDirNegocio, 
...
GROUP BY Usuario, Año, Mes,  Cliente, AGRUP, Contrato, CodDDirNegocio, NombreDirNegocio