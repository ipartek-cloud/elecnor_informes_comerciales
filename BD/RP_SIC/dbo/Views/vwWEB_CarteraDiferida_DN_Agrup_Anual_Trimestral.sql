CREATE VIEW [dbo].[vwWEB_CarteraDiferida_DN_Agrup_Anual_Trimestral]
AS
SELECT        Usuario, Año, Mes, CodDDirNegocio, NombreDirNegocio, SUM(CASE TIPO WHEN 'T' THEN NTrimestre * MontoTrimestre ELSE MontoAnual END) AS Total, SUM(Contrat) AS Contrat, 
