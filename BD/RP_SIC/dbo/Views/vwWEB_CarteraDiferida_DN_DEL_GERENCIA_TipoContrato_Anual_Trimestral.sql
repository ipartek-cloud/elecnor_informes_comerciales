CREATE VIEW [dbo].[vwWEB_CarteraDiferida_DN_DEL_GERENCIA_TipoContrato_Anual_Trimestral]
AS
SELECT        Usuario, Año, Mes, CodDDirNegocio, NombreDirNegocio, CodDelegacion, NombreDelegacion, GERENCIA,AGRUP, 
...
GROUP BY Usuario, Año, Mes, CodDDirNegocio, NombreDirNegocio, CodDelegacion, NombreDelegacion, GERENCIA,AGRUP