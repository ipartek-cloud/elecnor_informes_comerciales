CREATE VIEW dbo.vwOfertas_AsociadasInversion
AS
SELECT     CDCEN, CDOFT, FECHAA, DCOF, CDCLI, LOCAL, PROOF, IMAOF, CDAC1, CDAC2, DECOF, RPROF, FECHPP, PREVE, FECHAD, ADELE, PREAD, TCOS, 
                      TVEN, [USER], WS10, DESPRO, BAJA, ASOCIADAINVERSION
FROM         OPENQUERY([SIC], 
