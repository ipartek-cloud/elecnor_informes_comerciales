CREATE VIEW dbo.vwContratacion_AS400_2018
AS
SELECT        AÑOAD AS Año, MESAD AS Mes, CT AS CodCentro, CODOFER, DESOFER, CODCLIENTE, NOMCLIENTE, IMPAD AS Importe
FROM            OPENQUERY(SIC, 
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[27] 4[18] 2[9] 3) )"
      End
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "Contratacion_AS400_2018"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 135
