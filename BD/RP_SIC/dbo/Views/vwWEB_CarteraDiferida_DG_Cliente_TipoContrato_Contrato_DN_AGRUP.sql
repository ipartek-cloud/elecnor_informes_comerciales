CREATE VIEW [dbo].[vwWEB_CarteraDiferida_DG_Cliente_TipoContrato_Contrato_DN_AGRUP]
AS
SELECT        Usuario, Año, Mes, CodDirGeneral, Cliente, AGRUP, Contrato, CodDDirNegocio, 
...
GROUP BY Usuario, Año, Mes, CodDirGeneral, Cliente, AGRUP, Contrato, CodDDirNegocio, 
                         NombreDirNegocio