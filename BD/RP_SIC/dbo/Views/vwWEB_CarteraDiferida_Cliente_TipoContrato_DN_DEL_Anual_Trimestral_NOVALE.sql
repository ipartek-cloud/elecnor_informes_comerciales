CREATE VIEW [dbo].[vwWEB_CarteraDiferida_Cliente_TipoContrato_DN_DEL_Anual_Trimestral_NOVALE]
AS
SELECT        Usuario, Año, Mes, Cliente, AGRUP, CodDDirNegocio, NombreDirNegocio, CodDelegacion, NombreDelegacion,
...
GROUP BY Usuario, Año, Mes, Cliente, AGRUP, CodDDirNegocio, NombreDirNegocio, CodDelegacion, NombreDelegacion