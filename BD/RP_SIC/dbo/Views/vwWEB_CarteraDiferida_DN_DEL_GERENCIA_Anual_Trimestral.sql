...
CREATE VIEW [dbo].[vwWEB_CarteraDiferida_DN_DEL_GERENCIA_Anual_Trimestral]
AS
SELECT        Usuario, Año, Mes, CodDDirNegocio, NombreDirNegocio, CodDelegacion, NombreDelegacion, GERENCIA, 
...
GROUP BY Usuario, Año, Mes, CodDDirNegocio, NombreDirNegocio, CodDelegacion, NombreDelegacion, GERENCIA
