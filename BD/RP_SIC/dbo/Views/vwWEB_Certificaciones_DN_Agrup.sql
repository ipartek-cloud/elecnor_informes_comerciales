CREATE VIEW [dbo].[vwWEB_Certificaciones_DN_Agrup]
AS
SELECT        Usuario, CodDDirNegocio, NombreDirNegocio, SUM(NumReferencias_ALL) AS NumReferencias_ALL, SUM(NumCBE_ALL) AS NumCBE_ALL, SUM(NumOfertas_2016) 
...
GROUP BY Usuario,CodDDirNegocio, NombreDirNegocio