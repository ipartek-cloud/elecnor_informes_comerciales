CREATE VIEW dbo.vwOfertas_AsociadasInversion_Pais
AS
SELECT     dbo.vwOfertas_AsociadasInversion.CDCEN AS CodCentro, dbo.vwOfertas_AsociadasInversion.CDOFT AS CodOferta, 0 AS NumRegularizacion, 
                      ...
                      dbo.Provincias.Pais AS Mercado, dbo.Provincias.NMPRO AS Pais, dbo.vwOfertas_AsociadasInversion.ASOCIADAINVERSION
FROM         dbo.vwOfertas_AsociadasInversion INNER JOIN
                      dbo.Provincias ON dbo.vwOfertas_AsociadasInversion.PROOF = dbo.Provincias.CDPRO
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwOfertas_AsociadasInversion_Pais';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwOfertas_AsociadasInversion_Pais';
