CREATE VIEW dbo.vwWEB_CarteraDiferida_GERENCIA_TipoContrato_Agrup_Anual_Trimestral
AS
...
WHERE        (NOT (CASE TIPO WHEN 'T' THEN NTrimestre * MontoTrimestre ELSE MontoAnual END < 0.5)) OR
                         ...
                         (NOT (A_Año1 < 0.5)) OR
                         (NOT (A_Año < 0.5))
GROUP BY Usuario, Año, Mes, Gerencia, AGRUP
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwWEB_CarteraDiferida_GERENCIA_TipoContrato_Agrup_Anual_Trimestral';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwWEB_CarteraDiferida_GERENCIA_TipoContrato_Agrup_Anual_Trimestral';
