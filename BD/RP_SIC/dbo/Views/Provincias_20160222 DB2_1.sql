CREATE VIEW dbo.[Provincias_20160222 DB2]
AS
SELECT        CDAUT, NMAUT, CDPRO, NMPRO, dbo.fnPais(CDAUT) AS Pais
FROM            OPENQUERY(SIC, 
                         '
SELECT        CAutonoma.CDAUT, CAutonoma.NMAUT, Provincias.CDPRO, Provincias.NMPRO
FROM            S44DD901.ICOMERF.IC05AP AS Provincias INNER JOIN
