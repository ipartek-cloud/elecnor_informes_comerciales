CREATE VIEW dbo.[vwOfertas_AsociadasInversion_Pais_Cliente_Desglose]
AS
SELECT     dbo.vwOfertas_AsociadasInversion.CDCEN AS CodCentro, dbo.vwOfertas_AsociadasInversion.CDOFT AS CodOferta, 0 AS NumRegularizacion, 
                      ...
                      dbo.ClientesSQL.NomAgrupado, dbo.ClientesSQL.NomAgrupadoDesglose, dbo.ClientesSQL.Pais
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[25] 4[19] 2[17] 3) )"
      End
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Append = 1400
         NewValue = 1170
         SortTyp', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwOfertas_AsociadasInversion_Pais_Cliente_Desglose';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'e = 1350
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwOfertas_AsociadasInversion_Pais_Cliente_Desglose';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwOfertas_AsociadasInversion_Pais_Cliente_Desglose';
