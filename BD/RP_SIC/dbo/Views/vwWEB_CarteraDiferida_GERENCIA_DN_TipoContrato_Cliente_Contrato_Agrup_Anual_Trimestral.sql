...
CREATE VIEW [dbo].[vwWEB_CarteraDiferida_GERENCIA_DN_TipoContrato_Cliente_Contrato_Agrup_Anual_Trimestral]
AS

SELECT        Usuario, Año, Mes, Gerencia,CodDDirNegocio, NombreDirNegocio, AGRUP, Cliente, Contrato, SUM(CASE TIPO WHEN 'T' THEN NTrimestre * MontoTrimestre ELSE MontoAnual END) AS Total, 
...
GROUP BY Usuario, Año, Mes, Gerencia,CodDDirNegocio, NombreDirNegocio, AGRUP,Cliente, Contrato, FInicio, FFinal, FFinalEfectiva
