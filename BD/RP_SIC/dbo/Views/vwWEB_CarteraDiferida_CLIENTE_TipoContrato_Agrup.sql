...
CREATE VIEW [dbo].[vwWEB_CarteraDiferida_CLIENTE_TipoContrato_Agrup]
AS
SELECT        Usuario, Año, Mes, Gerencia,Agrup, Cliente, SUM(CASE TIPO WHEN 'T' THEN NTrimestre * MontoTrimestre ELSE MontoAnual END) AS Total, SUM(Contrat) AS Contrat, 
...
GROUP BY Usuario, Año, Mes, Gerencia,AGRUP, Cliente, Tipo
