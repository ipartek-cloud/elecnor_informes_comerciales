...
public class DGCentrosResponseDto
{
...
public class DelegacionDto
{
    ...
    public List<CentroDto> Centros { get; set; } = new();
    public TotalesDelegacionDto Totales { get; set; } = new();
}
...
public class TotalesDelegacionDto
{
