...
public class MercadosSGDelegacionesController : ControllerBase
{
    ...
    public async Task<IActionResult> Get([FromQuery] int anio, [FromQuery] int mes, [FromQuery] string codSubDirGeneral = "221", [FromQuery] int? nroPagina = null)
    {
        try
        {
            ...
            var result = await _service.ObtenerInformeAsync(anio, mes, codSubDirGeneral, nroPagina);
