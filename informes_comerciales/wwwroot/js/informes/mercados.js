...
function _renderCabeceraCompartida(tituloCentral = 'Mercado') {
    const anioAnterior = (estado.informeGlobalData?.meta?.filtros?.anio - 1) || '2025';
    ...
    return `
        ...
        <thead>
            ...
            <tr class="fw-bold">
                <th class="text-end pe-2 rpt-mercado-th-border">Objet.</th>
                <th class="text-end pe-2 rpt-mercado-th-border">Contr.</th>
                ...
                <th class="text-end pe-2 rpt-mercado-th-border">Objet.</th>
                <th class="text-end pe-2 rpt-mercado-th-border">Contr.</th>
                <th class="text-center rpt-mercado-th-border">Ip</th>
                <th class="text-center rpt-mercado-th-border">Var/${anioAnterior}</th>
            </tr>
        </thead>
    `;
}
